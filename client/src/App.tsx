...
function Router() {
  return <Switch><Route path="/" component={Marketplace} /><Route path="/app" component={MobileApp} /><Route path="/landing" component={Home} /><Route path="/login" component={Login} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
