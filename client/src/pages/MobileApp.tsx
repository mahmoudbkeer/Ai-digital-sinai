...
import { displayBusinessOsValue, getBusinessOsMutation, isBusinessOsModuleId, loadBusinessOsModule, loadBusinessOsProduct, loadBusinessOsProducts, mutateBusinessOsModule, setBusinessOsProductStatus, updateBusinessOsProduct, type BusinessOsData, type BusinessOsProduct } from "@/lib/businessOsApi";
...
export default function MobileApp() {
  ...
  const loadModuleData = async (module: SectorModule) => {
    ...
    try {
      ...
      setModuleData(data); setModuleDataState("ready");
    } catch (error) {
